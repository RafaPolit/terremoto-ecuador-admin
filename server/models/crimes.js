...
module.exports = db.define('crimes', {
  ...
  status_report: { type: Sequelize.ENUM('reported','in_progress','attended','closed'), defaultValue: 'reported' }, // enum('reported','in_progress','attended','closed') DEFAULT 'reported',
  ...
  email: { type: Sequelize.STRING, allowNull: true, defaultValue: null}, // varchar(255) DEFAULT NULL,
}, {
  timestamps: true,
